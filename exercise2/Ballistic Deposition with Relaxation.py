...
for i in range(10):
    ...
    for batch in range(num_batches):
        ...
        for _ in range(particles):
            ...
            h_center = height[x]
            h_left = height[left_x]
            h_right = height[right_x]

            
            min_h = min(h_left, h_right, h_center)
            ...
            if h_center > min_h:
                ...
                if h_left < h_right:
                    ...
                    y = h_left if random.random() < 0.5 else h_right  
            else:
                y = h_center  
...
plt.xlabel("X")
plt.ylabel("Y")
plt.title("Ballistic Deposition with Relaxation (Periodic Boundaries)")
plt.show()
'''